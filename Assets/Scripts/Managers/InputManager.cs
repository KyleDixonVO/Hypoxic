...
namespace UnderwaterHorror 
{
    public class InputManager : MonoBehaviour
    {
        ...
        void UpdateLastNumPressed()
        {
            ...
            {
                UI_Manager.ui_Manager.inventoryButtons[0].SetThisAsCaller();
                _lastNumKeyPressed = 0;
            }
            else if (Input.GetKeyDown(KeyCode.Alpha2))
            {
                UI_Manager.ui_Manager.inventoryButtons[1].SetThisAsCaller();
                _lastNumKeyPressed = 1;
            }
            else if (Input.GetKeyDown(KeyCode.Alpha3)) 
            {
                UI_Manager.ui_Manager.inventoryButtons[2].SetThisAsCaller();
                _lastNumKeyPressed = 2;
            } 

            lastNumKeyPressed = _lastNumKeyPressed;
        }

        public void SetLastNumPressed(int value)
        {
            _lastNumKeyPressed = value;
            lastNumKeyPressed = _lastNumKeyPressed;
        }
